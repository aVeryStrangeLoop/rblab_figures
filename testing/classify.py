...
ofile = open("peak_fractions.csv","w+")
ofile.write("res,mut,pop,p0,p1,p2,p3,p4\n")
# Lowmut
mut = "l"
for pop in POPs:
    for res in RESs:
        ...
        with open("data_w_mech.csv") as ifile:
            for line in ifile:
                words = line.split(",")
                if words[0]==res and words[1]==mut and int(words[2])==pop:
                    ...
                    if scf > l_max0-bw_l and scf < l_max0+bw_l:
                        ...
                        p4 +=1.0
        ofile.write("%s,%s,%d,%f,%f,%f,%f,%f\n" % (res,mut,pop,p0/tot,p1/tot,p2/tot,p3/tot,p4/tot))
            ...
            for line in ifile:
                ...
                if words[0]==res and words[1]==mut and int(words[2])==pop:
                    ...
                    if scf > h_max0-bw_h and scf < h_max0+bw_h:
                        ...
                        p3 +=1.0
        ofile.write("%s,%s,%d,%f,%f,%f,%f,\n" % (res,mut,pop,p0/tot,p1/tot,p2/tot,p3/tot))
